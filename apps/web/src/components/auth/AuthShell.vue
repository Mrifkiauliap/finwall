  ...
  <div class="flex min-h-dvh w-full bg-background">
    ...
    >
      <div class="pointer-events-none absolute inset-0" aria-hidden="true">
        <div
          class="absolute -right-24 -top-32 size-96 rounded-full bg-primary-foreground/10 blur-3xl"
        />
        <div class="absolute -bottom-40 -left-24 size-96 rounded-full bg-black/10 blur-3xl" />
      </div>
    ...
    >
      <div class="pointer-events-none absolute inset-0 lg:hidden" aria-hidden="true">
        <div class="absolute -left-32 -top-32 size-80 rounded-full bg-primary/10 blur-3xl" />
        <div class="absolute -bottom-32 -right-32 size-80 rounded-full bg-primary/5 blur-3xl" />
      </div>
      ...
      <div class="relative z-10 w-full max-w-md space-y-6">
        ...
        <div
          class="space-y-5 rounded-2xl border bg-card p-6 text-card-foreground shadow-elevation-md sm:p-8"
        >
          <slot />
        </div>

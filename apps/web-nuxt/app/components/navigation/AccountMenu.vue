<!-- app/components/navigation/AccountMenu.vue -->
...
<template>
  <div ref="rootEl" class="relative">
    ...
    <button
      type="button"
      class="flex items-center gap-2 rounded-lg p-1.5 pr-2 hover:bg-muted transition-colors"
      aria-haspopup="true"
      ...
      >
        ...
        >
          <span class="flex items-center gap-3">
            ...
            {{
              themeStore.isDark
                ? t("accountmenu.THEME_DARK")
                : t("accountmenu.THEME_LIGHT")
            }}
          </span>
        ...
        <NuxtLink
          to="/settings/profile"
          class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-foreground hover:bg-muted transition-colors"
          role="menuitem"
          @click="close"
        >
        ...
        <button
          type="button"
          class="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-muted-foreground hover:bg-destructive/10 hover:text-destructive transition-colors"
        ...
        >
          ...
          {{
            isLoggingOut
              ? t("common.navigation.LOGGING_OUT")
